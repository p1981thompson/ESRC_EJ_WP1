...
names(sim_dat_NA2)<-c("k", "id", "NAC", "NAA", "WOA", "NWOA", "WC")
...
NAC-WC;",
OUTPUT = "TECH1 TECH8;",
usevariables = c("NAC", "NAA", "WOA", "NWOA", "WC"),
rdata = sim_dat_NA2[,!names(sim_dat_NA2) %in% c("id","k")])

fit <- mplusModeler(pathmodel, modelout = "model_LPA1.inp", run = 1L,check=TRUE,varwarnings=TRUE)


screenreg(fit, single.row=TRUE)
