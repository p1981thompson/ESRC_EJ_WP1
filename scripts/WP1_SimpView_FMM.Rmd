...
fmm_a_rerun <- mm_extract_data(orig_mods = m_fmm_a, candidate_mods = 2:3,   # change models to best candidates
...
```{r fmm-b-candidates}
# Extract participant level data
fmm_b_rerun <- mm_extract_data(orig_mods = m_fmm_b, candidate_mods = 3:4, # change models to best candidates
                               filepath = "./mplus_models/simpview/fmm",
                               rerun = TRUE, optseed = NA,                   # extract optimal values from output files
                               one_fit = TRUE)
