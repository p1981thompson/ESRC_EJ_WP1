...
fmm_a_rerun <- mm_extract_data(orig_mods = m_fmm_a, candidate_mods = 3:4,    # change to candidate models
...
```{r fmm-b-candidates}
# Extract participant level data
fmm_b_rerun <- mm_extract_data(orig_mods = m_fmm_b, candidate_mods = 3:4,   # change to selected candidate models
                               filepath = "./mplus_models/compprof/fmm", analysis_id = "cp",
