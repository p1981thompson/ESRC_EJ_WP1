...
mplusModeler(m_lpa_benchmark, "./mplus_models/lpa/sv_lpa_mbenchmark.dat", run = TRUE)
...
m_lpa_a <- lapply(1:6, function(k) {
   ...
   mplusModeler(body, sprintf("mplus_models/lpa/sv_lpa_a_%dclass.dat", k), run = TRUE)
 })
```
...
```{r lpa-a-output}
# Read in output
lpa_a_out <- readModels(target = "./mplus_models/lpa", filefilter = "sv_lpa_a")
...
m_lpa_b <- lapply(1:6, function(k) {
   ...
   mplusModeler(body, sprintf("mplus_models/lpa/sv_lpa_b_%dclass.dat", k), run = TRUE)
 })
```
...
```{r lpa-b-output}
# Read in output
lpa_b_out <- readModels(target = "./mplus_models/lpa", filefilter = "sv_lpa_b")
...
m_lpa_c <- lapply(1:6, function(k) {
  ...
  body <- update(body,
   ...
   mplusModeler(body, sprintf("mplus_models/lpa/sv_lpa_c_%dclass.dat", k), run = TRUE)
 })
...
```{r lpa-c-output}
# Read in output
lpa_c_out <- readModels(target = "./mplus_models/lpa", filefilter = "sv_lpa_c")
...
m_lpa_d <- lapply(1:6, function(k) {
  ...
  body <- update(body,
   ...
   mplusModeler(body, sprintf("mplus_models/lpa/sv_lpa_d_%dclass.dat", k), run = TRUE)
 })
```
...
```{r lpa-d-output}
# Read in output
lpa_d_out <- readModels(target = "./mplus_models/lpa", filefilter = "sv_lpa_d")
...
m_lpa_e <- lapply(1:6, function(k) {
  ...
  body <- update(m_lpa_base,
   ...
   mplusModeler(body, sprintf("mplus_models/lpa/sv_lpa_e_%dclass.dat", k), run = TRUE)
 })
```
...
```{r lpa-e-output}
# Read in output
lpa_e_out <- readModels(target = "./mplus_models/lpa", filefilter = "sv_lpa_e")
