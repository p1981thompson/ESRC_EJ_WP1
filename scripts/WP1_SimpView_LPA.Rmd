...
lpa_a_rerun <- mm_extract_data(orig_mods = m_lpa_a, candidate_mods = 2:3,    # change models to best candidates
                               filepath = "./mplus_models/simpview/lpa",
                               rerun = TRUE, optseed = NA,                   # extract optimal values from output files
                               one_fit = TRUE)
...
```{r lpa-b-candidates}
# Extract participant level data
lpa_b_rerun <- mm_extract_data(orig_mods = m_lpa_b, candidate_mods = 2:4,   # change models to best candidates
                               filepath = "./mplus_models/simpview/lpa",
                               rerun = TRUE, optseed = NA,                   # extract optimal values from output files
                               one_fit = TRUE)
...
```{r lpa-c-candidates}
# Extract participant level data
lpa_c_rerun <- mm_extract_data(orig_mods = m_lpa_c, candidate_mods = 3:5,  # change models to best candidates
                               filepath = "./mplus_models/simpview/lpa",
                               rerun = TRUE, optseed = NA,                 # extract optimal values from output files
                               one_fit = TRUE)
...
```{r lpa-d-candidates}
# Extract participant level data
lpa_d_rerun <- mm_extract_data(orig_mods = m_lpa_d, candidate_mods = 2:3,   # change models to best candidates
                               filepath = "./mplus_models/simpview/lpa",
                               rerun = TRUE, optseed = NA,                   # extract optimal values from output files
                               one_fit = TRUE)
...
```{r lpa-e-candidates}
# Extract participant level data
lpa_e_rerun <- mm_extract_data(orig_mods = m_lpa_e, candidate_mods = 2:3,    # change models to best candidates
                               filepath = "./mplus_models/simpview/lpa",
                               rerun = TRUE, optseed = NA,                   # extract optimal values from output files
                               one_fit = TRUE)
