...
final_mod <- readModels(target = "./mplus_models/simpview/shape/crossval", filefilter = "lpa4_full")  # final model file
...
ggsave("../output/figures/lpa4full_6class_desc.tiff", dpi = 600, width = 7, height = 5)
