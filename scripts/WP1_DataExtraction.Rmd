...
# Create numeric ID variable for working with mplus
wp1_data <- wp1_data %>% 
...
Missing data are coded as negative values in raw data; recode as NA to avoid incorporating into analyses. 
